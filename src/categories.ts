    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Micronaut", status: "TRIAL", priority: false },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Terraform", status: "ADOPT", priority: false },
          { name: "Redis", status: "ADOPT", priority: false },
          { name: "Kafka", status: "ADOPT", priority: false },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Eventdriven", status: "ADOPT", priority: false },
          { name: "IaC", status: "ADOPT", priority: false },
          {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Snowflake", status: "ADOPT", priority: false },
          ...
          { name: "Pandas for Spark 3.0", status: "ADOPT", priority: false },
          { name: "EMR", status: "KEEP", priority: false },
          { name: "Managed Airflow", status: "KEEP", priority: false },
          { name: "BigQuery", status: "KEEP", priority: false },
          { name: "Apache Spark", status: "KEEP", priority: false },
          { name: "Jupyterhub", status: "KEEP", priority: false },
          { name: "Jupyter notebooks", status: "KEEP", priority: false },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "ETL", status: "KEEP", priority: false },
        ],
      },
      {
        name: "frameworks",
        id: "frameworks",
        items: [
          { name: "DBT", status: "ADOPT", priority: false },
          ...
          { name: "Tensorflow", status: "KEEP", priority: false },
          { name: "Pandas", status: "KEEP", priority: false },
          ...
          { name: "Delta Live Tables", status: "TRIAL", priority: false },
